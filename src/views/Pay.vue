<template>
  <div class="pay">
    <van-nav-bar title="结算订单" left-text="返回" left-arrow @click-left="goback" />
    <div class="pay-box">
    ...
    <div class="pay-btn">
      <van-button color="#5C4033" block round @click="pay">立即结算</van-button>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    getShopbagDataByPay() {
      ...
      this.axios({
        ...
        .then((res) => {
          console.log("res getShopbagDataByPay ==> ", res);
          this.$toast.clear();
